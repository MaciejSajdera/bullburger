...
export default function OrderButtonModal(){
  ...
  function closeModal(){
    ...
    return (
      ...
      <button onClick={openModal} id={`goorderButton`} className={`goorder`} data-goorder-open class="goorder" data-goorder-modal="1" data-src="https://bullpub.goorder.pl">
...
ReactDOM.render(<OrderButtonModal />, "#___gatsby");
